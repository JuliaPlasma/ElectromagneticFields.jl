...
@testset "$(rpad("Plotting",60))" begin
    ...
    for equ in rectangular_equilibria
        @test plot_equilibrium(equ; xlims=(0.6, 1.4), ylims=(-0.4, +0.4)) isa Makie.Figure
    end
    ...
    @test plot_equilibrium(Singular.init(); nx=101, ny=101, colorbar=true) isa Makie.Figure
    @test plot_equilibrium(Singular.init(); xlims=(2.0, 3.0), ylims=(2.0, 3.0)) isa Makie.Figure
