...
ElectromagneticFields.minx³(ξ::AbstractVector{T}, equ::AbstractSolovevEquilibrium) where {T} = T(0)
ElectromagneticFields.maxx³(ξ::AbstractVector{T}, equ::AbstractSolovevEquilibrium) where {T} = T(2π)
